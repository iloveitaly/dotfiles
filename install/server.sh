...
if [ ! -f /etc/apt/sources.list.d/azlux.list ]; then
  ...
  echo "deb [signed-by=/usr/share/keyrings/azlux-archive-keyring.gpg arch=$(dpkg --print-architecture)] http://packages.azlux.fr/debian stable main" | sudo tee /etc/apt/sources.list.d/azlux.list
fi
